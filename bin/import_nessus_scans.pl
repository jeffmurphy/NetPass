#!/usr/bin/perl -w
#
# $Header: /tmp/netpass/NetPass/bin/import_nessus_scans.pl,v 1.1 2004/09/24 01:05:19 jeffmurphy Exp $
...
$Id: import_nessus_scans.pl,v 1.1 2004/09/24 01:05:19 jeffmurphy Exp $
