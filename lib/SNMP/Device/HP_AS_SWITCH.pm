# $Header: /tmp/netpass/NetPass/lib/SNMP/Device/HP_AS_SWITCH.pm,v 1.1 2004/09/24 01:05:20 jeffmurphy Exp $
...
sub get_if_info {
	...
	my $oids = {
			'port'	  	  => '.1.3.6.1.2.1.22.1.3.1.1.2.116',
			'if_descr'  	  => '.1.3.6.1.2.1.22.1.3.1.1.2.116',
			'if_ad_status'	  => '.1.3.6.1.2.1.22.1.3.1.1.3.116',
			'if_status'	  => '.1.3.6.1.2.1.22.1.3.1.1.5.116'
		   };
